...
Have a look at the auto-suggestions through the tab key to have a look at the available commands and variables.
JSON is native within the elasticshell, thus auto-suggestions are available within JSON objects too.
