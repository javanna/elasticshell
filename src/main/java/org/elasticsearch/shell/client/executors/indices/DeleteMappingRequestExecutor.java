 ...
 * @author Luca Cavanna
 *
 * {@link org.elasticsearch.shell.client.executors.RequestExecutor} implementation for delete mapping API
 */
public class DeleteMappingRequestExecutor<JsonInput, JsonOutput> extends AbstractRequestExecutor<DeleteMappingRequest, DeleteMappingResponse, JsonInput, JsonOutput> {

    public DeleteMappingRequestExecutor(Client client, JsonSerializer<JsonInput, JsonOutput> jsonSerializer) {
