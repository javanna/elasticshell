 ...
 * @author Luca Cavanna
 *
 * {@link org.elasticsearch.shell.client.executors.RequestExecutor} implementation for (get) aliases indices API
 */
public class GetAliasesIndicesRequestExecutor<JsonInput, JsonOutput> extends AbstractRequestExecutor<ClusterStateRequest, ClusterStateResponse, JsonInput, JsonOutput> {

    public GetAliasesIndicesRequestExecutor(Client client, JsonSerializer<JsonInput, JsonOutput> jsonSerializer) {
