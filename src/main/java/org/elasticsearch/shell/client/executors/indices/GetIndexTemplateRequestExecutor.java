 ...
 * @author Luca Cavanna
 *
 * {@link org.elasticsearch.shell.client.executors.RequestExecutor} implementation for (get) index template API
 */
public class GetIndexTemplateRequestExecutor<JsonInput, JsonOutput> extends AbstractRequestExecutor<ClusterStateRequest, ClusterStateResponse, JsonInput, JsonOutput> {

    public GetIndexTemplateRequestExecutor(Client client, JsonSerializer<JsonInput, JsonOutput> jsonSerializer) {
