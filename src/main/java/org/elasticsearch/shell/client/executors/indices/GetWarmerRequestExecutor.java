 ...
 * @author Luca Cavanna
 *
 * {@link org.elasticsearch.shell.client.executors.RequestExecutor} implementation for (get) warmer API
 */
public class GetWarmerRequestExecutor<JsonInput, JsonOutput> extends AbstractRequestExecutor<ClusterStateRequest, ClusterStateResponse, JsonInput, JsonOutput> {

    private final String name;

    public GetWarmerRequestExecutor(Client client, JsonSerializer<JsonInput, JsonOutput> jsonSerializer, String name) {
