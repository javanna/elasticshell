 ...
 * @author Luca Cavanna
 *
 * {@link org.elasticsearch.shell.client.executors.RequestExecutor} implementation for put mapping API
 */
public class PutMappingRequestExecutor<JsonInput, JsonOutput> extends AbstractRequestExecutor<PutMappingRequest, PutMappingResponse, JsonInput, JsonOutput> {

    public PutMappingRequestExecutor(Client client, JsonSerializer<JsonInput, JsonOutput> jsonSerializer) {
