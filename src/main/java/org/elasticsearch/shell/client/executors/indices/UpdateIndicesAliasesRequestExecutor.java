 ...
 * @author Luca Cavanna
 *
 * {@link org.elasticsearch.shell.client.executors.RequestExecutor} implementation for get indices aliases API
 */
public class UpdateIndicesAliasesRequestExecutor<JsonInput, JsonOutput> extends AbstractRequestExecutor<IndicesAliasesRequest, IndicesAliasesResponse, JsonInput, JsonOutput> {

    public UpdateIndicesAliasesRequestExecutor(Client client, JsonSerializer<JsonInput, JsonOutput> jsonSerializer) {
