 ...
 * @author Luca Cavanna
 *
 * Custom {@link NativeJavaObject}. The goal is to get access to some {@link NativeJavaMethod} properties that have
 ...
 * What we can do is customize what our {@link NativeJavaObject} returns when a method is requested through the get method
 */
public class RhinoCustomNativeJavaObject extends NativeJavaObject {

    public RhinoCustomNativeJavaObject(Scriptable scope, Object javaObject, Class<?> staticType) {
